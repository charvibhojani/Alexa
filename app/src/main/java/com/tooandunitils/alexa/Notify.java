...
//    String[] s = {"Alexa, do I have any notifications?", "Alexa,  check my notifications", "Alexa, what are my notifications?", "Alexa, read the latest notification", "Alexa, dismiss all notifications", "Alexa,  clear my notifications", "Alexa, enable notifications for WhatsApp", "Alexa, disable notifications for SnapChat", "Alexa, configure notifications", "Alexa, manage my notification preferences"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] Item = new String[]{"Alexa, do I have any notifications?", "Alexa,  check my notifications", "Alexa, what are my notifications?", "Alexa, read the latest notification", "Alexa, dismiss all notifications", "Alexa,  clear my notifications", "Alexa, enable notifications for WhatsApp", "Alexa, disable notifications for SnapChat", "Alexa, configure notifications", "Alexa, manage my notification preferences"};

        ListAdapter listAdapter = new ListAdapter(Item, Notify.this);
