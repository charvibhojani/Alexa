...
//    String[] s = {"Alexa, Play music", "Alexa, Sing Jingle Bells", "Alexa, Sing Auld Lang Syne", "Alexa, Sing your new Christmas song", "Alexa, Sing a christmas carol", "Alexa, Play music for a christmas party", "Alexa, Play family friendly christmas music", "Alexa, create a new playlist", "Alexa, skip the song", "Alexa, loop this playlist"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] Item = new String[]{"Alexa, Play music", "Alexa, Sing Jingle Bells", "Alexa, Sing Auld Lang Syne", "Alexa, Sing your new Christmas song", "Alexa, Sing a christmas carol", "Alexa, Play music for a party", "Alexa, Play family friendly music", "Alexa, create a new playlist", "Alexa, skip the song", "Alexa, loop this playlist"};

        ListAdapter listAdapter = new ListAdapter(Item, Music.this);
