...
//    String[] s = {"Alexa, what can you show me?", "Alexa, show the living room camera", "Alexa, show the weekend forecast", "Alexa, show me some interesting videos on YouTube", "Alexa, show me a recipe from AllRecipes", "Alexa, play my video", "Alexa, show me my timers", "Alexa, open uber", "Alexa, shoe me a movie show times", "Alexa, open Zomato"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Echo.this, Home.class);
                startActivity(intent);
                finish();
            }
        });

        String[] Item = new String[]{"Alexa, what can you show me?", "Alexa, show the living room camera", "Alexa, show the weekend forecast", "Alexa, show me some interesting videos on YouTube", "Alexa, show me a recipe from AllRecipes", "Alexa, play my video", "Alexa, show me my timers", "Alexa, open uber", "Alexa, shoe me a movie show times", "Alexa, open Zomato"};

        ListAdapter listAdapter = new ListAdapter(Item, Echo.this);
