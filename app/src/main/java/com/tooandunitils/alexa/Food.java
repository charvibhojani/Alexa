...
//    String[] s = {"Alexa, find restaurants near me", "Alexa,  search for pizza places in Vesu", "Alexa, where is the nearest grocery store?", "Alexa, find coffee shops in Surat", "Alexa, tell me about Construction", "Alexa, what are the customer reviews for [business name]", "Alexa, find food delivery near me", "Alexa, suggest a recipe for [dish/ingredient]", "Alexa, what are some healthy recipes?", "Alexa, what are some low-carb recipes?"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] Item = new String[]{"Alexa, find restaurants near me", "Alexa,  search for pizza places in Vesu", "Alexa, where is the nearest grocery store?", "Alexa, find coffee shops in Surat", "Alexa, tell me about Construction", "Alexa, what are the customer reviews for [business name]", "Alexa, find food delivery near me", "Alexa, suggest a recipe for [dish/ingredient]", "Alexa, what are some healthy recipes?", "Alexa, what are some low-carb recipes?"};

        ListAdapter listAdapter = new ListAdapter(Item, Food.this);
