...
//    String[] s = {"Alexa, Volume up", "Alexa, Volume down", "Alexa, Resume", "Alexa, Stop", "Alexa, Next", "Alexa, play last song", "Alexa, play favorite playlist on spotify", "Alexa, tell me more about this artist", "Alexa, add this song to my playlist", "Alexa, play some romantic songs on spotify"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Spotify.this, Home.class);
                startActivity(intent);
                finish();
            }
        });

        String[] Item = new String[]{"Alexa, Volume up", "Alexa, Volume down", "Alexa, Resume", "Alexa, Stop", "Alexa, Next", "Alexa, play last song", "Alexa, play favorite playlist on spotify", "Alexa, tell about Arijit", "Alexa, add song to playlist", "Alexa, play romantic songs"};

        ListAdapter listAdapter = new ListAdapter(Item, Spotify.this);
