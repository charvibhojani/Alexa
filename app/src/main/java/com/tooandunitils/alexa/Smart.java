...
//    String[] s = {"Alexa, find my smart home devices", "Alexa, turn on TV", "Alexa, lock main gate", "Alexa, show me the camera", "Alexa, dim the lights to 50%", "Alexa, turn off living room lights", "Alexa, make the kitchen lights a little warmer", "Alexa, turn on Netflix", "Alexa, runaway mode", "Alexa, turn lights out"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Smart.this, Home.class);
                startActivity(intent);
                finish();
            }
        });

        String[] Item = new String[]{"Alexa, find my smart home devices", "Alexa, turn on TV", "Alexa, lock main gate", "Alexa, show me the camera", "Alexa, dim the lights to 50%", "Alexa, turn off living room lights", "Alexa, make the kitchen lights a little warmer", "Alexa, turn on Netflix", "Alexa, runaway mode", "Alexa, turn lights out"};

        ListAdapter listAdapter = new ListAdapter(Item, Smart.this);
