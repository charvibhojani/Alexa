...
public class Call extends Activity {
    ...
    ListView listView;
    ImageView back;
//    String[] s = {"Alexa,  call the last number", "Alexa, answer the call", "Alexa, pick up", "Alexa,  hang up", "Alexa, end the call", "Alexa, call 123456789 on speakerphone", "Alexa,  call Daddy's mobile phone", "Alexa, call Mummy on speakerphone", "Alexa, dial friend", "Alexa, stop the call"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] Item = new String[]{"Alexa,  call the last number", "Alexa, answer the call", "Alexa, pick up", "Alexa,  hang up", "Alexa, end the call", "Alexa, call 123456789 on speakerphone", "Alexa,  call Daddy's mobile phone", "Alexa, call Mummy on speakerphone", "Alexa, dial friend", "Alexa, stop the call"};

        ListAdapter listAdapter = new ListAdapter(Item, Call.this);
