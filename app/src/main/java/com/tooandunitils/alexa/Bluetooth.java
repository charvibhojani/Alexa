...
public class Bluetooth extends Activity {
    ...
    ImageView back;
    ListView listView;
//    String[] s = {"Alexa,  pair Bluetooth", "Alexa, discover my devices", "Alexa, find Bluetooth devices", "Alexa, enter Bluetooth pairing mode", "Alexa, start device discovery", "Alexa,  play music on Bluetooth", "Alexa, skip to the next song on Bluetooth", "Alexa, go back on Bluetooth", "Alexa, disconnect Bluetooth", "Alexa, increase Bluetooth volume"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bluetooth.this, Home.class);
                startActivity(intent);
                finish();
            }
        });

        String[] Item = new String[]{"Alexa,  pair Bluetooth", "Alexa, discover my devices", "Alexa, find Bluetooth devices", "Alexa, enter Bluetooth pairing mode", "Alexa, start device discovery", "Alexa,  play music on Bluetooth", "Alexa, skip to the next song on Bluetooth", "Alexa, go back on Bluetooth", "Alexa, disconnect Bluetooth", "Alexa, increase Bluetooth volume"};

        ListAdapter listAdapter = new ListAdapter(Item, Bluetooth.this);
