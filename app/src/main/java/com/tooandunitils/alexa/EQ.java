...
public class EQ extends Activity {
    ...
    ListView listView;
    ImageView back;
//    String[] s = {"Alexa, set the treble to three", "Alexa, set night mode", "Alexa, increase bass", "Alexa, decrease bass", "Alexa, increase bass in living room", "Alexa, set night mode on bedroom tv", "Alexa, set movie mode", "Alexa, set bass to two on the soundbar", "Alexa, decrease treble", "Alexa, disable night mode"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EQ.this, Home.class);
                startActivity(intent);
                finish();
            }
        });

        String[] Item = new String[]{"Alexa, set the treble to three", "Alexa, set night mode", "Alexa, increase bass", "Alexa, decrease bass", "Alexa, increase bass in living room", "Alexa, set night mode on bedroom tv", "Alexa, set movie mode", "Alexa, set bass to two on the soundbar", "Alexa, decrease treble", "Alexa, disable night mode"};

        ListAdapter listAdapter = new ListAdapter(Item, EQ.this);
